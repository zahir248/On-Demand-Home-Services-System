...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" style="height: auto; max-height: 100vh; overflow-y: auto;">
  ...
  <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Service Provider</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            ...
            <span class="nav-link-text ms-1">Manage Service Provider</span>
        </a>
      </li>
      <li class="nav-item">
          <a class="nav-link {{ Request::is('manage-service-categories') ? 'active' : '' }}" href="{{ url('manage-service-categories') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>customer-support</title>
                      <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Manage Service Categories</span>
          </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            ...
            <span class="nav-link-text ms-1">Manage Request</span>
        </a>
      </li>
      <li class="nav-item mt-2">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
          ...
          <span class="nav-link-text ms-1">Manage Booking Request</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('virtual-reality') ? 'active' : '') }}" href="{{ url('virtual-reality') }}">
          ...
          <span class="nav-link-text ms-1">Earning and Payouts</span>
        </a>
      </li>
      <li class="nav-item">
